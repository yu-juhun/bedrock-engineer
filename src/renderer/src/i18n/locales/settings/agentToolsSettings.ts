export const agentToolsSettings = {
  en: {
    ...
    'Tool Detail Settings Description': 'In this tab, you can configure advanced settings for specific tools. Settings are available for Knowledge Base retrieval, command execution, and Bedrock Agent invocation when these tools are enabled.',
    ...
    'No configurable tools enabled. Enable retrieve, executeCommand, or invokeBedrockAgent tools to access their configurations.': 'No configurable tools enabled. Enable retrieve, executeCommand, or invokeBedrockAgent tools to access their configurations.',
    ...
    'Only allow commands that you trust this agent to execute. Use wildcards (*) to define patterns.': 'Only allow commands that you trust this agent to execute. Use wildcards (*) to define patterns.',
  ...
  ja: {
    ...
    'Tool Detail Settings Description': 'このタブでは、特定のツールの詳細設定を行えます。ナレッジベース検索、コマンド実行、Bedrock Agentの呼び出しなど、これらのツールが有効になっている場合に設定が可能です。',
    ...
    'No configurable tools enabled. Enable retrieve, executeCommand, or invokeBedrockAgent tools to access their configurations.': '設定可能なツールが有効になっていません。retrieve、executeCommand、または invokeBedrockAgent ツールを有効にして設定にアクセスしてください。',
